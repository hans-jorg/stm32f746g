...
--------------------------------------
 ...
 The LCD display has a Capacitive Touch Display (CTP), controlled thru HTC043C.
...
|  LCD_INT        | INT    | PI13 |  0 | GPIOI 13 | Interrupt              |
...
@brief   Configuration for STM32F746G Discovery Board
